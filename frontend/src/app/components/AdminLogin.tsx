        ...
        <Card className="border-gray-200 shadow-xl shadow-gray-200/50">
          <CardContent className="p-8 space-y-6">
            <div className="space-y-2 text-center">
              <h2 className="text-xl font-semibold text-gray-900">Acceso Administrativo</h2>
              <p className="text-sm text-gray-500">Acceso exclusivo para personal autorizado</p>
            </div>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-3 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-orange-700 mt-1">
                  Este panel requiere credenciales administrativas. Todos los accesos quedan registrados.
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-gray-600">Mantener sesion</span>
                </label>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-4">
              <p className="text-xs text-slate-700 text-center">
                <strong>Acceso real:</strong> utiliza una cuenta con permisos de administracion.
              </p>
            </div>
          </CardContent>
        </Card>
