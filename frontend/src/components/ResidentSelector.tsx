...
interface ResidentSelectorProps {
  ...
  onAddMembers: (residents: Resident[]) => Promise<void>;
}
  ...
  useEffect(() => {
    const loadResidents = async () => {
      ...
      try {
        ...
        const availableResidents = data.filter(
          (r) => r.is_active && !currentMemberEmails.has(r.email)
        );
            ...
            <>
              ...
              >
                {isAdding ? (
                  ...
                  <>
                    Añadir {selectedResidents.size > 0 ? selectedResidents.size : ""}{" "}
                    residente{selectedResidents.size !== 1 ? "s" : ""}
                  </>
                )}
              </Button>
            </>
