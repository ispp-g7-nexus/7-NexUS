...
import { Clock, ChevronRight, MapPin, Plus, Send, Image as ImageIcon } from 'lucide-react';
        ...
        <div className={UI_CLASSES.modalPadding}>
          ...
          <div className="space-y-5">
              ...
              <section className="flex justify-center mb-2">
                <div className="rounded-[24px] overflow-hidden border border-slate-100 shadow-sm max-w-[200px] bg-slate-50">
                  <img 
                    src={incidence.img} 
                    alt="Evidencia" 
                    className="w-full h-auto object-contain max-h-[160px] hover:scale-105 transition-transform cursor-zoom-in" 
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className={UI_CLASSES.label}>Técnico</label>
                    ...
                    <div key={u.id} className={UI_CLASSES.historyBubble}>
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span className="text-[9px] text-slate-400 font-bold">
                          {new Date(u.created_at).toLocaleString('es-ES', { day: '2-digit', month: '2-digit', hour: '2-digit', minute: '2-digit' })}
                        </span>
                      </div>
            ...
            <div>
              ...
              <div className="relative">
                <textarea value={newComment} onChange={(e) => setNewComment(e.target.value)} placeholder="Escribe la actualización aquí..." className={UI_CLASSES.textarea} />
                ...
                <div key={inc.id} className={UI_CLASSES.card}>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <div className={UI_CLASSES.cardDate}>
                          <Clock size={12} /> {new Date(inc.created_at).toLocaleDateString()}
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    <div className={UI_CLASSES.cardLocation}>
                      <MapPin size={14} /> {LOCATION_LABELS[inc.location_type]} {inc.room_number || ''}
                    </div>
...
const UI_CLASSES = {
  ...
  modalContainer: "bg-white w-full max-w-lg rounded-[35px] overflow-hidden shadow-2xl relative",
  modalPadding: "p-8",
  ...
  input: "w-full bg-slate-50 border border-slate-100 rounded-2xl h-11 px-4 font-bold text-slate-700 outline-none focus:ring-2 focus:ring-emerald-500 text-sm",
  ...
  historyScrollArea: "bg-slate-50/50 border border-slate-100 rounded-2xl p-3 max-h-40 overflow-y-auto space-y-2 mb-2",
  historyBubble: "bg-white p-3 rounded-xl border border-slate-100 shadow-sm"
};