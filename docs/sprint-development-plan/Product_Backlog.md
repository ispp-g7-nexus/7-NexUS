...
[Revisiones_Grupo1] Hacer revisión en profundidad de la aplicación del grupo 1.                         L.R.1
...
[Revisiones_Grupo10] Hacer revisión en profundidad de la aplicación del grupo 10.                   L.R.2
Desc: Esta tarea se asignará a 3 personas estas personas deberán dividirse las distintas partes de la aplicación y hacer una revisión durante 1h a fondo de lo que tienen hehco generanod cada uno un informe de incidencias que vean. (Revisión muy en profundidad buscando todos los detalles)

Módulo: Panel Residencias

[Admin/Room] Ver detalle de una habitación.    2.1
...
[Admin/Residentes] Lógica de asignación de estudiantes a habitaciones. 2.4
Desc: Al dar de alta en la residencia a un nuevo estudiante debe poder asignarsele una habitación.

[Refactor] [Admin/Room/UX/UI] Detalle descripción habitaciones en listado general 2.2
...
[Refactor] [Admin/Room/UX/UI] Refactorización vista de los botones de las habitaciones 2.3
Descr: Dejar en la zona de listado de habitaciones un único botón para ver los detalles e introducir las opciones de edición y eliminación de la misma dentro de los detalles (Para entender mejor mirar los mockups).   [Deps --> 2.1]

[Admin/Room] Ver perfil de estudiante desde su habitación.    2.5
Desc: Al acceder al detalle de una habitación se muestran sus estudiantes asociados junto con un botón de perfil, al clicar encima del estudiante o del botón debe abrirte el perfil del estudiante en cuestión (Para entender mejor mirar los mockups).  [Deps --> 2.1,2.4]

[Admin/Room] Ver historial de acciones efectuadas sobre una habitación.    2.6
Desc: En el detalle de una habitación aparece un botón abajo de ver historial al clickar debe de mandar a un pop-up de historial en el que aparezca un registro de eventos de la habitación (Para poder entender mirar los mockups de figma).  [Deps --> 2.1]


[Technical_debt] [Admin/Room] Formulario de edición de  habitaciones 2.7
...
[Refactor] [Admin/Room] Filtrado de habitaciones 2.8
...
[Admin/Room] Vista en forma de mapa de las habitaciones. 2.9
Descripción Se necesita que las habitaciones aparezcan en forma de mapa dividido por edificios y plantas, y que esta vista esté asociado al CRUD ya existente para ver el detalle de cada una al clicar en ella(mirar en los mockups)          [Deps --> 2.1]


[Admin/PanelControl] Ver analíticas rápidas al scrollear en el panel.   2.10/3.1
Desc: Muestro de analíticas de actividad reciente y ocupación del edificio en la zona baja del menú de administrador(mirar en los mockups para entender mejor) [ Deps --> Modulos Panel de Control] 

[Refactor] [Admin/MenuDesplegble] Vista de usuario activo en el menú lateral. 2.11
Desc: Al abrir el menú lateral encima de Cerrar sesión se debe mostrar el usuario con el que se está logueado.


Módulo: Incidencias -->  (Posible extensión hacia plantillas) (Estadísticas de incidencias plantearnos poder ver de un vistazo la cantida de incidencias de cada tipo que hay)

[Admin/Incidencias] Poder crear una nueva incidencia.           2.12
Desc: Poder crear desde el panel de administración una nueva incidencia, para ver los campos de creación basarrse un poco de como se hace en la interfaz de residente, añadiendole los campos que se ven en la edición de incidencias como admin, al crear una incidencia además tener en cuenta que te permita asignarla a un miembro del staff y que cuando aparezca el dropdown para seleccionar dicho miembro puedas filtrar por rol. (Si hay alguna duda preguntar PO)                     [Similitud --> 2.13]

[Admin/Incidencias] Asignación de staff al gestionar incidencias.       2.13
Desc: Modificar el campo de asignar técnico a incidencia para que aparezca como un dropdown en el que se pueda filtrar por rol del staff.  [Similitud --> 2.12] 


[Residente/Incidencias] Funcionalidad para adjuntar imágenes a incidencias.   2.14
Desc: Como residente poder adjuntar una imagen a la hora de enviar el reporte de una nueva incidencia (Campo opcional). [Similitud --> 2.15]

[Admin/Incidencias] Funcionalidad para adjuntar imágenes a incidencias como administrador.   2.15
Desc: Como administrador poder adjuntar una imagen a la hora de una nueva incidencia (Campo opcional).      [Deps --> 2.12] [Similitud --> 2.14]

[Residente/Incidencia] Notificaciones push/email sobre cambios en incidencias propias.      2.16
...
[Admin/Incidencias] Interfaz de gestión de incidencias añadir pipeline.                     2.17
...
[Admin/Incidencias] Lógica de priorización automática de incidencias.               2.18
Desc: Comprobar si actualmente muestra el listado por orden de urgencia y prioridad, si no lo hace que lo haga.

[Residente/Incidencias] Eliminar doble botón de X de la interfaz.                   2.19
...
[Admin/EspaciosComunes] Poder añadir imagen al crear o editar un espacio.               2.22
...
[Refactor] [Residente/EspaciosComunes] Mejorar sistema de horas de reserva.             2.23
...
[Residente/Espacioscomunes] Visualización de disponibilidad en tiempo real.             2.24
Descr: Antes de reservar una hora en concreto poder ver que horas ya están reservadas y que no deje al usuario reservar en esa franja horaria. [Deps --> 2.23]

[Backend] Sistema de recordatorios automáticos de reservas.                         2.25
Descr: Cuando se aproxime la hora de inicio de la reserva que llegue una notificación en la app al residente avisándole de que pronto iniciará su reserva del espacio.   [Deps --> 2.23]

Módulo: Comunicación
[Admin/Chats] Poder acceder desde el panel de admin a los chats.        2.28
...
[Residente/Chat] Poder acceder desde la vista de residente a los chats. 2.31
Desc: Crear la entrada en la UI que esté conectada al backend de chats para gestionar los chats como residente.  
[deps --> 2.26]

[Admin/Chats] CRUD de chats.       2.26
Desc: Poder crear, editar, elimar o ver un chat y listar todos en pestañas, solo los administradores pueden crear los chats que quieran(por ej. avisos, general,....). En esta versión a la hora de crear un chat adición de miembros muy básica. [Deps --> 2.28]

[Admin/Chats] Adición de miembros al chat.                      2.27
Desc: A la hora de crear un nuevo chat o a la hora de añadir miembros a uno existente, que tenga atajos de adición rápida, tipo select all que permita meter a todos los residentes, o select condicionales que por ejemplo permitan incluir a todas las personas apuntadas a un evento concreto para crear el chat del evento(caso de uso mencionado por usuario piloto).   [Deps--> 2.26]

[Admin/Eventos] Creación rápida de chat.            2.29
...
[Residente/Eventos] Creación rápida de chat.            2.30
Desc: A través de un botón de bocadillo de texto que salga en la tarjeta del evento creado por el admin, sea un atajo para crear el chat del evento que incluye automáticamente a su owner y a todos los participantes.
[Sim --> 2.29]

[User/Chats] Como usuario poder abandonar un chat.                  2.32
Desc: Botón de salida de chat al entrar en el detalle de loos miembros tipo whatsapp o algo así. En caso de chats básicos de la residencia que estén marcados no se pueede. [Deps--> 2.26]

[User/Chats] Como administrador de chat(NO ADMIN DE RESI).          2.33
Desc: Poder eliminar personas del chat y hacer admin a personas del chat, y siendo admin de la residencia siempre eres admin de los chats. [Deps--> 2.26]

[Admin/Chats] Poder borrar mensajes ajenos de chats. 2.34
Desc: como administrador de la residencia(que no del grupo) puedes moderar todos los chats borrando cualquier mensaje que veas oportuno  [Deps-->2.26]



Módulo: Paquetería
[Admin/Paqueteria] Hacer CRUD de paqueteria    2.35
...
[Admin/Paqueteria] Marcar paquete entregado          2.38
Desc: Como administrador poder marcar la entrega de un paquete.
[Deps --> 2.37]
[Admin/Paqueteria] Crear vista de paquetería (Frontend). 2.37
...
[Residente/Paqueteria] Crear vista de paquetería.            2.39
...
[Residente] Notificación de llegada.                  2.40
...
[Refactor] [Admin/Residentes] Edición de residentes.                        L.3.13

Desc: No poder cambiarle la contraseña a un residente desde la edición de residentes.

Módulo: Social

[Refactor] [Residente/Social] Cambiar visiualización perfil.                    L.3.12
...
Módulo: Comunicación       --> Lolo y Miguel
...
[Backend] Chats recomendados.                                   L.3.1
...
[Admin/Roles] Gestión de menús                  L.3.2
...
[Admin/Roles] Gestión de permisos adheridos a menú                L.3.3
...
[Deps --> L.3.2]
 ...
 Módulo: Premium Lolo y Miguel
[Admin/Premium] Interfaz de customización de la imagen de marca de la residencia 								L.3.4
...
[Admin/Premium] Modificar el banner e icono en el header de la aplicación												L.3.5
...
[Admin/Premium] Añadir colores dinámicos según la customización del administrador								L.3.6
...
Módulo: Comedor
[Admin/Comedor] CRUD de menú semanal.                   2.41
...
[Residente/Comedor]	Ver menús ya planificados para próximas semanas													L.2.2
...
[Residente/Comedor]  Ver estado de MIS solicitudes 							L.3.7
...
[Residente/Comedor] Crear solicitudes								L.3.8
...
[Residente/Comedor] Sistema de autorización de recogida por otro residente eligiendo menú 											L.3.9.
...
[Residente/Comedor] Gestionar solicitudes de recogida. 										L.3.10
...
[Admin/Comedor]: Sección picnics( ver si meterlo en nueva seccion o en solicitudes especiales) --> Al no poderse aceptar o rechazar plantear si cuanod pasa la comida en la que esta planificada se borre auto de la vista		L.3.11
...
Módulo: Legal
[Admin/Legal] Eliminación usuario residente      M.N2.1
...
[Admin/Visitante] Notificación al administrador     M.N2.9
...
[Refactor] [Residentes/Notificaciones] Coherencia notificaciones		M.N2.18
...
[Admin/Notificaciones] Descartar notificaciones			M.N2.19
Desc: Como administrador quiero poder descartar las notificaciones del desplegable de notificaciones (Con una X por ej.)

[Refactor] [Admin/Notificaciones] Coherencia notificaciones		M.N2.20	
...
[Refactor] [Admin/Notificaciones] Icono notificaciones			M.N2.21
...
[Residente/PanelControl] Icono MiPerfil				 M.N2.25
...
[Residente/Matching]: Rediseño de matches                                   Matching.1
Desc: Como residente quiero un diseño del listado de matches más descriptivo y visual
 
[Residente/Matching]: Like de matches                                        Matching.2
...
[Residente/Matching]: Notificación de like                                   Matching.3
Desc: Como residente quiero recibir una notificación sin algún match me da like. [Deps--> Matching.2]


Módulo: Eventos
[Residente/Eventos]: Recomendación de eventos                   Matching.4
Desc: Como residente quiero que me aparezcan eventos afines a los datos de mi perfil.

[Admin/Eventos]: Análisis de eventos                Matching.5
...
---------------------------------AÑADIDO POR ALEJANDRO E IGNACIO---------------------------------------------

Módulo: Multi-sede Igna y ale
[Admin/Personal] Panel central de control de todas las residencias y comparativa de métricas.
...
Módulo: Analíticas Igna y ale
[Admin/Personal] Generación de analíticas de habitaciones, incidencias, objetos y espacios.
- Añadir a barra lateral.
- Poder exportar reportes en pdf, incluso reportes excel mas concretos (usando filtros etc...)


Módulo: Calidad & Cierre    Igna y ale
[QA] Testing de seguridad pre-lanzamiento.

[QA/Front] Verificación PWA y corrección de bugs críticos de UX.


Módulo: Objetos             Igna y ale
[Backend] Envío de recordatorios automáticos de devolución, mediante el uso de avisos.

[Residente] Listar las reservas activas del residente en otro apartado del navbar (Espacios-Objetos-Mis Reservas) A.2.01

[Residente] Mapeo de fechas disponibles de objetos A.2.02

[Admin/Objetos] En reserva de objetos obligatorio añadir una categoria asociada a dicho objeto, creando un enumerado que pueda tomar estos valores (ENTRETENIMIENTO, LIMPIEZA, LAVANDERIA, UTILIDADES, COCINA Y DEPORTE), y opcionalmente asignar tambien un stock para definir la cantidad de objetois disponibles en la residencia. Asignar un icono (MIRAR FIGMA) degun la categoria del objeto. Añadir barra de filtros: buscador, dropdowns multi seleccion. A.2.03

[Admin/Objetos] Ver detalles y editar objetos A.2.04. (Deps -> A.2.03)

[Admin/Objetos] Poder marcar como devuelto un objeto. A.2.05

[Backend] Vinculación lógica de reserva de espacio con préstamo de objetos core.

-----LAS DE OBJETOS S2 QUE CREO QUE NO HABIAIS ANALIZADO-------
Módulo: Objetos --> No esta hecho como se pensaba tipo préstamo con solicitudes, darle una vuelta a la ejecución dle mismo
CRUD esta bien faltaría el stock, y adjuntar imagen                                                                                              Igna y ale


[Admin/Objetos] Poder editar un objeto.             2.20
Desc: En la pantalla de reservas de admin que haya un botón que despliegue un formulario de edición de objeto, en caso de que no estén gestionados los updates en backend que se gestione.

[Residente] Consulta de disponibilidad en tiempo real y solicitud de préstamo.

[Admin/Objetos] Interfaz para aceptar o rechazar solicitudes de préstamo.

[Admin/Residente] Historial de uso y préstamos por objeto.
