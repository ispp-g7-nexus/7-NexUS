...
| 2.0.0 | 07/04/2026 | Inclusión de pruebas end-to-end con Playwright |

**Nota:** Este documento es una actualización del documento perteneciente al sprint 2, que se deja sin modificar en la carpeta correspondiente para dejar intactos los documentos de dicho sprint
...
- Validar **flujos End-to-End** de usuario mediante pruebas automatizadas con Playwright
...
Las pruebas end-to-end validan flujos completos de usuario a través de la aplicación, simulando interacciones reales:

- **Flujos de autenticación**: Login, logout, recuperación de contraseña
- **Operaciones principales**: Reservas, creación de incidencias, navegación
- **Interacción multi-usuario**: Escenarios con varios usuarios interactuando
- **Comportamiento del navegador**: Compatibilidad con Chrome, Firefox, Edge, Safari
- **Errores y edge cases**: Comportamiento ante fallos de red, timeouts, datos inválidos

Los tests E2E se implementarán con **Playwright** para garantizar cobertura multiplataforma y compatibilidad con navegadores modernos.
...
- El frontend se complementa con pruebas informales funcionales durante desarrollo y revisión. La automatización de pruebas con Vitest se realizará si hay suficiente tiempo.
- Los tests E2E con Playwright se ejecutan cuando P1 y P2 están estables.
...
- **E2E**: Se ejecutan tests E2E con Playwright tras validación de P1 y P2.
...
- **Testing E2E**: Tests end-to-end tras estabilización de funcionalidades principales
...
Los tests E2E se priorizan sobre P3 pero después de P1 y P2 completados.
...
| **Flujos E2E principales** | Cobertura de flujos críticos | Playwright |
...
| **Tests E2E exitosos** | 100% | Playwright |
...
La estrategia definida combina pruebas unitarias, de integración y end-to-end con el objetivo de detectar errores durante el desarrollo y reducir su impacto en producción.

El uso de herramientas automatizadas permitirá ejecutar las pruebas de forma continua durante el ciclo de desarrollo, facilitando el mantenimiento del sistema y la evolución futura del proyecto. La inclusión de tests E2E con Playwright proporciona validación completa de flujos de usuario reales.
