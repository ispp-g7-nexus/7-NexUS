...
class IsEventsAdmin(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return has_screen_permission(request.user, residence, "events")


# Mantenemos la función original por si la usas en otro sitio
