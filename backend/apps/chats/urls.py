...
from .views import ChatEventsStreamView, ChatGroupViewSet, ChatGroupLabelViewSet, MyGroupsViewSet, PrivateConversationViewSet, ResidentListForChatView
...
urlpatterns = [
	...
	path("chats/events/", ChatEventsStreamView.as_view(), name="chat-events"),
]
