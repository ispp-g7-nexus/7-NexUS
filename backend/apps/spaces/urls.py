...
urlpatterns = [
    ...
    path(
        "admin/spaces/",
        AdminSpaceListCreateView.as_view(),
        name="admin-space-list-create",
    ),
    path(
        "admin/spaces/<int:space_id>/",
        AdminSpaceDetailView.as_view(),
        name="admin-space-detail",
    ),
    path(
        "admin/spaces/<int:space_id>/reservations/",
        AdminSpaceReservationsView.as_view(),
        name="admin-space-reservations",
    ),
    path(
